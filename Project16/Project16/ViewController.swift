...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let brasilia = Capital(title: "Brasilia", coordinate: CLLocationCoordinate2D(latitude: -15.793889, longitude: -47.882778), info: "The newest capital of the Americas")
        ...
        mapView.addAnnotations([brasilia, london, oslo, paris, rome, washington])
    }
    ...
    @objc func changeMapType() {
        let ac = UIAlertController(title: "Maps", message: "Select the map type", preferredStyle: .actionSheet)
