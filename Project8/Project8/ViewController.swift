...
class ViewController: UIViewController {
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            let ac = UIAlertController(title: "Try again!", message: "Please, do the next try!", preferredStyle: .alert)
    ...
    @objc func loadLevel() {
        ...
        if let levelFireURL = Bundle.main.url(forResource: "level\(level)", withExtension: "txt") {
            if let levelContents = try? String(contentsOf: levelFireURL) {
